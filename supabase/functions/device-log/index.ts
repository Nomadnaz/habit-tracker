...
- "weight" is a body-weight reading: "log my weight as 80kg", "I weigh 175 pounds", "weighed in at twelve and a half stone" -> weight_kg (convert units per the rule above). Do NOT confuse with "exercise" -- exercise needs a named exercise + reps; a bare weight with no exercise name and no rep count is always "weight", never "exercise".
- "sleep" is total time slept, said as a duration: "I slept 7 hours", "got eight and a half hours last night" -> total_hours.
- "mood" needs an explicit rating or a mood word mapped to one on a 1-10 scale: "I'm feeling a 7 today", "pretty good, an 8" -> mood_score 7/8. A mood mentioned only in passing with nothing rateable ("I'm a bit tired") is not enough -- "unclear".
